...
export default function Dashboard() {
    ...
    const ToolButton = ({ icon, label, onClick }) => (
        <div className="col-4 mb-2">
            <button 
                type="button" 
                className="d-flex flex-column align-items-center justify-content-start p-0 border-0 shadow-none w-100 h-100 hoverable" 
    ...
    // Component for recent ratings items
